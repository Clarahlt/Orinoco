...
//Création d'une fonction 'send(e)' => Envoie les données au serveur afin de recevoir une réponse contenant un numéro Id
 function send(e) {
  e.preventDefault();
  const options = {
    method: "POST",
...
function hydratatePage(){
  ...
  thanks.innerText = 'Merci' + ' ' + validCaddy.contact.firstName + ' ' +  'pour votre confiance !'
